<?php
/*
   Plugin Name: WP Geo Tags
   Plugin URI: http://www.linkarbeit.net/
   Description: With WP Geo-Tags you can add the meta-tags geo.region, geo.placename, geo.position and ICBM to every post and page separately.
   Version: 1.0
   Author: Frank Kugler
